...
@section('content')
    ...
    <section id="home">
      <div class="hero-slider relative h-screen">
        <!-- Slide 1: Foto Gedung Fakultas Teknik -->
        ...
        <div class="grid lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <div class="space-y-8">
              <article class="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow border border-gray-100">
                <div class="p-6">
                  ...
                  <a href="{{ url('detail-berita') }}" class="text-primary hover:text-accent font-semibold">Baca Selengkapnya →</a>
                </div>
              </article>
            ...
            <div class="text-center mt-8">
              <a href="#" class="bg-primary hover:bg-accent text-white px-8 py-3 rounded-lg font-semibold transition-colors inline-block">
                Lihat Semua Berita
              </a>
            </div>
          </div>
