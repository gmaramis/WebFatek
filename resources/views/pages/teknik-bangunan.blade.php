...
@section('title', 'Teknik Bangunan - Fakultas Teknik UNIMA')
        ...
        <div class="grid md:grid-cols-2 gap-12 items-center">
          <div class="text-white">
            <div class="flex items-center mb-6">
              ...
              <div>
                <h1 class="text-4xl md:text-5xl font-bold mb-4">Teknik Bangunan</h1>
                <p class="text-xl text-gray-200">Program Studi S1</p>
              </div>
            </div>
            <p class="text-lg mb-8 text-gray-200 leading-relaxed">
              Program studi yang fokus pada perancangan, konstruksi, dan manajemen bangunan untuk menciptakan infrastruktur yang aman, nyaman, dan berkelanjutan.
            </p>
      ...
      <div class="container mx-auto px-4">
        <div class="text-center mb-16">
          ...
          <p class="text-xl text-gray-600 max-w-3xl mx-auto">
            Program Studi Teknik Bangunan dirancang untuk menghasilkan lulusan yang kompeten dalam bidang konstruksi, perancangan, dan manajemen bangunan.
          </p>
        </div>
        <div class="grid md:grid-cols-3 gap-8 mb-16">
          <div class="text-center p-6 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors">
            ...
            <p class="text-gray-600">
              Menjadi program studi unggul dalam pengembangan ilmu dan teknologi bangunan yang inovatif dan berkelanjutan.
            </p>
          </div>
          <div class="text-center p-6 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors">
            ...
            <p class="text-gray-600">
              Menyelenggarakan pendidikan, penelitian, dan pengabdian masyarakat di bidang teknik bangunan yang berkualitas dan relevan dengan kebutuhan industri dan masyarakat.
            </p>
          </div>
          <div class="text-center p-6 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors">
            ...
            <p class="text-gray-600">
              Menghasilkan lulusan yang profesional, beretika, dan mampu beradaptasi dengan perkembangan teknologi bangunan dan konstruksi.
            </p>
          </div>
        </div>
        <!-- ... dan seterusnya ... -->
