...
document.addEventListener("DOMContentLoaded", function () {
  ...
  try {
    ...
    const programCards = safeQuerySelectorAll(".bg-white.rounded-lg.shadow-lg");
...
function initHeroSlider() {
  ...
  const dots = safeQuerySelectorAll(".slider-dot");
  ...
  const heroSlider = safeQuerySelector(".hero-slider");
  if (heroSlider) {
