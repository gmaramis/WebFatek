...
class ZonaIntegritasContentSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        ZonaIntegritasContent::create([
            'section' => 'kontak',
            'title' => 'Tim Zona Integritas Fatek',
            'content' => 'zona.integritas@fatek.unima.ac.id',
            'description' => '+62-431-123456 ext. 456 | Gedung Fatek Lt. 1, Ruang Zona Integritas',
        ...
        ZonaIntegritasContent::create([
            ...
            'description' => 'Pengaduan dapat disampaikan secara langsung, melalui email, atau melalui kotak pengaduan yang tersedia di setiap gedung Fatek.',
        ...
        ZonaIntegritasContent::create([
            ...
            'description' => '+62-431-123456 ext. 456 | Gedung Zona Integritas Lt. 2, Fatek UNIMA',
            'icon' => 'heroicon-o-envelope-open',
            'color' => 'indigo',
            'order' => 16,
            'is_active' => true,
